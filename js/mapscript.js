...
// Date:     July 2017
// Authors:  Thomas Binu & Evgeni Dobranov
// Purpose:  Defines ArcGIS map, geo-location and geo-enrichment
...
function renderEsriMap(placesData)
{
	require([
        ...
        {
            var cycleButton = "<img id='esriLogo'>";
        ...
        function addBaseMapCycleButton()
		{
